...
TextureShaderClass::TextureShaderClass()
{
	...
	m_matrixBuffer = 0;
	m_sampleState = 0;
	m_fillMode = D3D11_FILTER_MIN_MAG_MIP_LINEAR;
}
...
void TextureShaderClass::SetFILLMode(ID3D11Device* device, D3D11_FILTER fillMode)
{
	if (m_sampleState) {
	...
	samplerDesc.MaxAnisotropy = (fillMode == D3D11_FILTER_ANISOTROPIC) ? 16 : 1;
