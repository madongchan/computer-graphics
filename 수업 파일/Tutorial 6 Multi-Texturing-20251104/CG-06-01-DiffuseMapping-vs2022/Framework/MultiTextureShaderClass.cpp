...
{
	// 정점 및 픽셀 쉐이더를 초기화합니다.
	return InitializeShader(device, hwnd, L"./data/multiTextureShader.hlsl");
}
...
bool MultiTextureShaderClass::InitializeShader(ID3D11Device* device, HWND hwnd, const WCHAR* fileName)
{
	ID3D10Blob* errorMessage = nullptr;

	// 버텍스 쉐이더 코드를 컴파일한다.
	ID3D10Blob* vertexShaderBuffer = nullptr;
	HRESULT result = D3DCompileFromFile(fileName, NULL, NULL, "MultiTextureVertexShader", "vs_5_0", 
	...
	result = D3DCompileFromFile(fileName, NULL, NULL, "MultiTexturePixelShader", "ps_5_0", 
